...
def YouTubeAuto(command):
    ...
    if 'pause' in query:
        ...
        Speak("What I Search Sir For You ?")
...
def Notepad():
    ...
    path_1 = "C:\\Users\\Dell\\Desktop\\Virtual assistant\\How To Make Jarvis\\" + str(filename)

    path_2 = "C:\\Users\\Dell\\Desktop\\Virtual assistant\\How To Make Jarvis\\DataBase\\NotePad\\" + str(filename)
